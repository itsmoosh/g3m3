	...
	do k=2,nz-1
		...
		do j=2,ny-1
			...
			do i=2,nx-1
				...
				qgradp_x = ( wrkqpresx(ii,j,k,box) &
					- wrkqpresx(im,j,k,box) )/dxt &
					+ ( wrkqpresxy(i,jj,k,box) &
					- wrkqpresxy(i,jm,k,box) )/dxt &
					+ ( wrkqpresxz(i,j,kk,box) &
					- wrkqpresxz(i,j,km,box) )/dxt
				qgradp_y = ( wrkqpresxy(ii,j,k,box) &
					- wrkqpresxy(im,j,k,box) )/dxt &
					+ ( wrkqpresy(i,jj,k,box) &
					- wrkqpresy(i,jm,k,box) )/dyt &
					+ ( wrkqpresyz(i,j,kk,box) &
					- wrkqpresyz(i,j,km,box) )/dxt
				qgradp_z = ( wrkqpresxz(ii,j,k,box) &
					- wrkqpresxz(im,j,k,box) )/dxt &
					+ ( wrkqpresyz(i,jj,k,box) &
					- wrkqpresyz(i,jm,k,box) )/dyt &
					+ ( wrkqpresz(i,j,kk,box) &
					- wrkqpresz(i,j,km,box) )/dzt
				...
				!	Pressure equations: off-diagonal elements
				...
				qpresxy(i,j,k,box)=qpresxy(i,j,k,box) &
					...
					*(qvy(i,j,kk)-qvy(i,j,km))/dzt &
					...
					-aby*wrkqpresyz(i,j,k,box) &
					+abx*wrkqpresxz(i,j,k,box))
				...
				qpresxz(i,j,k,box)=qpresxz(i,j,k,box) &
					...
					*(qvz(i,jj,k)-qvz(i,jm,k))/dyt &
					...
					-abx*wrkqpresxy(i,j,k,box) &
					+abz*wrkqpresyz(i,j,k,box))
				...
				qpresyz(i,j,k,box)=qpresyz(i,j,k,box) &
					...
					*(qvy(ii,j,k)-qvy(im,j,k))/dxt &
					...
					-abz*wrkqpresxz(i,j,k,box) &
					+aby*wrkqpresxy(i,j,k,box))
			enddo
		enddo
	enddo
